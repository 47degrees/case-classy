...
Discussion around Case Classy happens in the [Gitter channel](https://gitter.im/47deg/case-classy) as well as on
[GitHub issues](https://github.com/47deg/case-classy/issues) and [pull requests](https://github.com/47deg/case-classy/pulls).

Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about
the code. Pull requests are also welcome.

People are expected to follow the [Typelevel Code of Conduct](http://typelevel.org/conduct.html) when discussing Case Classy on the Github page, Gitter channel, or other venues.
...
Case Classy follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
